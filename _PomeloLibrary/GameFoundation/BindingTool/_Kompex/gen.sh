...
set -x
LD_LIBRARY_PATH=${CLANG_ROOT}/lib $PYTHON_BIN ${CXX_GENERATOR_ROOT}/generator.py ${CXX_GENERATOR_ROOT}/_Kompex/gen.ini -s testandroid -o ${CXX_GENERATOR_ROOT}/../external/Sqlite/JSBinding
