...
//
//        var right_pos_in_world = gLCore['stage_start_node'].getParent().convertToWorldSpace(gLCore['stage_start_node'].getPosition());
//        var right_pos_in_stage = Core.stage.convertToNodeSpace(right_pos_in_world);
//        var right_loc = Core.pos2loc(right_pos_in_stage);
//        var left_pos_in_world = gLCore['stage_end_node'].getParent().convertToWorldSpace(gLCore['stage_end_node'].getPosition());
//        var left_pos_in_stage = Core.stage.convertToNodeSpace(left_pos_in_world);
